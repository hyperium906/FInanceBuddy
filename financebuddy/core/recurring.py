...
a frequency costs in a month. :mod:`financebuddy.core.paycheck` imports it, so
...
same fifteen dollars leaving; :func:`financebuddy.core.paycheck.monthly_recurring_outflow`
